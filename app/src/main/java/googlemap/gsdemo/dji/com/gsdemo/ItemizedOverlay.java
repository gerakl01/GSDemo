...
*/
/**
 * Created by george on 09/02/2017.
 *//*
...
public abstract class ItemizedOverlay<Item extends OverlayItem> extends
        Overlay {
        ...
        synchronized (this.visibleItems) {
            ...
            for (int i = this.visibleItems.size() - 1; i >= 0; --i) {
                ...
                synchronized (checkOverlayItem) {
                    ...
                    int checkLeft = checkItemPoint.x
                            + checkMarkerBounds.left;
                    int checkRight = checkItemPoint.x
                            + checkMarkerBounds.right;
        ...
        for (int itemIndex = 0; itemIndex < numberOfItems; ++itemIndex) {
            ...
            synchronized (overlayItem) {
                ...
                if (drawZoomLevel != overlayItem.cachedZoomLevel) {
                    overlayItem.cachedMapPosition = projection.toPoint(
                ...
                this.itemPosition.x = overlayItem.cachedMapPosition.x
                        - drawPosition.x;
                this.itemPosition.y = overlayItem.cachedMapPosition.y
                        - drawPosition.y;
                ...
                if (this.right >= 0 && this.left <= canvas.getWidth()
                    ...
                    this.itemMarker.setBounds(this.left, this.top,
