...
/**
 * Created by George on 7/7/2016.
*
public class DroneCamera extends Activity implements SurfaceTextureListener,OnClickListener{




    private static final String TAG = DroneCamera.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drone_camera);
            ...
            camera.setDJICameraUpdatedSystemStateCallback(new DJICamera.CameraUpdatedSystemStateCallback() {
                ...
                public void onResult(DJICamera.CameraSystemState cameraSystemState) {
                    if (null != cameraSystemState) {
                        ...
                        DroneCamera.this.runOnUiThread(new Runnable() {
...
//        recordingTime.setVisibility(View.INVISIBLE);
    ...
    public void showToast(final String msg) {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(DroneCamera.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public static void switchCameraMode(CameraMode cameraMode){
